...
const businessLines: BusinessLine[] = [
  {
    ...
    projectIds: [0, 9, 2, 1], // 河套创新体系咨询、政治任务支撑、智绘链图、SlideCraft AI
  },
  {
    id: "platform",
    title: "平台运营落地",
  ...
  },
  {
    ...
    projectIds: [4, 8], // 金融diki研发、AI报告矩阵
  },
];
...
const projects: ProjectDetail[] = [
  ...
  },
  {
    ...
    // 对外价值与核心亮点
    externalValue: [
      "🏆 重大经营创效：项目初验谈判中争取3000万元运营资源，显著优化经营性现金流，有效支撑可持续运营",
  ...
  },
  {
    id: 9,
    title: "政治任务专项支撑",
    subtitle: "AI赋能多场景政治性任务快速响应",
    category: "AI赋能智库咨询转型",
    description: "多次紧急支撑需求多样化的政治性任务，包括国家创投基金摸底、全国独角兽画像、委领导出访及央企调研，利用AI技术实现高效率、高质量交付。",
    highlights: ["国家级基金支撑", "多场景快速响应", "海量数据资产"],
    image: "/gov_support.jpg",
    color: "border-gold",
    background: "面对国家创投基金董事长霍福鹏提出的深圳20+8产业摸底、书记布置的全国97家独角兽画像、李主任央企调研及委领导出访越南等高规格、急难重任务，传统方式难以满足时效要求。",
    solution: "依托全量企业产品库，通过工作流设计与AI检索增强技术，构建高颗粒度、准确度、召回率满足需求的产品词生成方法。严格按照“投早、投小、投创新、投硬科技”导向筛选分析。",
    features: [
      { icon: "Target", title: "国家基金摸底支撑", desc: "支撑国家创投基金20+8产业分析，按投资导向精准生成100+篇企业画像（0818）及天津创投企业分析" },
      { icon: "Zap", title: "多维紧急任务响应", desc: "快速完成全国97家独角兽报告（3-4月）、33家央企画像（0527）及越南出访企业信息生成（9-10月）" },
      { icon: "Database", title: "产品库构建", desc: "建成1.4万家企业产品库，具备2万家/小时产品词并发生成能力" },
      { icon: "Search", title: "市占率任务支撑", desc: "全力支撑“企业产品市占率任务”，满足高颗粒度、准确度与召回率需求" },
    ],
    metrics: [
      { value: "400+", label: "精准画像", change: "国家基金支撑" },
      { value: "97家", label: "独角兽报告", change: "书记紧急任务" },
      { value: "2万/h", label: "并发能力", change: "产品词生成" },
      { value: "1.4万", label: "产品库沉淀", change: "企业数据资产" },
    ],
    timeline: [
      { phase: "市占率任务", time: "2025 Q1", status: "done" },
      { phase: "独角兽/央企调研", time: "2025 Q2", status: "done" },
      { phase: "国家基金支撑", time: "2025 Q3", status: "done" },
      { phase: "越南出访支撑", time: "2025 Q4", status: "done" },
    ],
    internalValue: [
      "验证了AI应对高强度、紧急政治任务的实战能力",
      "沉淀了高质量的企业产品库数据资产（1.4万家）",
      "构建了通用的企业画像与产品词生成工作流技术",
    ],
    externalValue: [
      "为国家级基金投资决策提供精准数据支撑",
      "高效保障市领导及委领导的重要政务活动与决策",
      "展示了中心在AI赋能政务服务方面的核心竞争力",
    ],
  },
  {
    id: 1,
  ...
  },
  {
    ...
    color: "border-primary",
    problem:
      "在国家倡导“投早、投小、投硬科技”和千亿级创业基金入场的趋势下，大量中小硬科技企业进入视野，但信息高度分散且不透明，传统尽调严重依赖人工，成本高、周期长、质量难以保证，系统性投研能力不足的问题将逐步暴露。",
    solution:
            ...
            <div className="p-8">
              ...
              {selectedProject.metrics && (
                <div className="mb-8">
                  ...
                  <div
                    className={`grid gap-4 ${selectedProject.metrics && selectedProject.metrics.length === 3

    ...
    <section className="py-24 px-6 bg-secondary/20 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <ScrollReveal>
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gold/10 border border-gold/30 mb-6">
              <span className="text-gold text-sm font-medium">2025年度展望</span>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {plans.map((plan, index) => (
            <ScrollReveal key={plan.title} delay={index * 100}>
              <div className="group h-full p-6 rounded-2xl bg-gradient-card border border-border/50 hover:border-primary/30 transition-all duration-300 hover:-translate-y-1">
                {/* 优先级标签 */}
        ...
        <ScrollReveal delay={700}>
          <div className="mt-16 p-8 rounded-3xl bg-gradient-to-r from-primary/10 via-accent/10 to-gold/10 border border-primary/30">
